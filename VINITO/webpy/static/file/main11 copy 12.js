$(document).ready(function(){
    tablaPersonas = $("#tablaPersonas").DataTable({
       "columnDefs":[{
        "targets": -1,
        "data":null,
        "defaultContent": "<div class='text-center'><div class='btn-group'><button class='btn btn-warning btnwarning'>Editar</button><button class='btn btn-primary btnEditar'>Admitir</button><button class='btn btn-danger btnBorrar'>Rechazar</button><button class='btn btn-info btnDetalle'>Detalles</button></div></div>"  
       }],
